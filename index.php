		...
		<div id="outer_container">
			...
			<div id="facetiles">
				<?php foreach($friends['data'] as $friend) {
					echo '<div class="link"><a target="_top" href="http://facebook.com/profile.php?id='.$friend['id'].'" title="'.$friend['name'].'"><img src="http://graph.facebook.com/'.$friend['id'].'/picture" alt="'.$friend['name'].'"></a></div>';
				} ?>
			</div>
		</div>
	</body>
